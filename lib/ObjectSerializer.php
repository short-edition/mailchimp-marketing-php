...
class ObjectSerializer
{
     ...
     */
    public static function sanitizeForSerialization(mixed $data, ?string $format = null): object|string|array
    {
     ...
     * @return string the serialized object
     */
    public static function toQueryValue(\DateTime|array|string $object): string
    {
        if (is_array($object)) {
     ...
     * @return string the header string
     */
    public static function toString(\DateTime|string $value): string
    {
