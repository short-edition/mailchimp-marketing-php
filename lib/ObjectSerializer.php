...
class ObjectSerializer
{
     ...
     *
     * @return null|array|bool|float|int|object|string serialized form of $data
     */
    public static function sanitizeForSerialization(mixed $data, ?string $format = null): array|bool|float|int|object|string|null
    {
     ...
     */
    public static function toQueryValue(array|\DateTime|string $object): \DateTime|string
    {
        if (\is_array($object)) {
     ...
     */
    public static function toFormValue(\SplFileObject|string $value): \DateTime|string
    {
     ...
     *
     * @return null|array|\DateTime|\SplFileObject an single or an array of $class instances
     *
     * @throws \DateMalformedStringException
     */
    public static function deserialize(mixed $data, string $class, ?array $httpHeaders = null): array|\DateTime|\SplFileObject|null
    {
        if (null === $data) {
            return null;
        }
